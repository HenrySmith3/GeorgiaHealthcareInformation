...
<div class="form-group" id="selectclinic">
    <label>Select the clinic you wish to edit</label><br>
    <select id="selclinic" class="form-control">
        <option value="1">FillClinic...</option>
    </select>
</div>
...
<div class="form-group" id="spphone">
    <label>Spanish extension phone number (if they have one):</label><br>
