...
<div class="form-group" id="selectclinic">
    ...
    <form action="/html_form_action.asp">
        <textarea id="survNo" name="survNo" rows="1" cols="20" placeholder="hospital ID"><%out.write(hospital.getString("survNo"));%></textarea>
