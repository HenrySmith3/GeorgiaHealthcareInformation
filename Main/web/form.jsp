...
<fieldset class="form-step">
    ...
    <div class="form-group" id="free">
        <label>Do you qualify for free clinic services? (proof of residency and monthly earnings required)</label><br>
...
<fieldset class="form-step">
    ...
    <div class="form-group" id="trans">
        ...
        <select id="transportation" class="form-control">
            ...
            <option value="3">MARTA Bus</option>
            <option value="4">Taxi</option>
        </select>
    </div>

    <div class="form-group" id="parking">
        <label>Do you require parking spaces?</label><br>
...
<fieldset class="form-step">
    ...
    <!--<div class="form-group" id="language">
        <label>Do you require any of the following faculty members to speak Spanish? (Check all that applies)</label><br>
    ...
    <div class="form-group" id="call">
        <label>Would you want someone available on the phone after the clinic's normal business hours?</label><br>
        <label class="radio-inline" for="yes">
...
<fieldset class="form-step">
    ...
    <div class="form-group" id="type">
        <label>Do you need the clinic to handle any of the following? (Check all that applies)</label><br>
    ...
    <div class="form-group" id="children">
        <label>Do you need pediatrics? (Ages 0-24) **Add to the specialties in the previous question*</label><br>
        <label class="radio-inline" for="yes">
    ...
    <div class="form-group" id="mentalhealth">
        <label>Do you need mental health services, counseling, or rehabilitation services in any of the following? (Check all that applies)</label>
        <label class="checkbox">
        ...
        <label class="checkbox">
            <input id="sexLGBT" type="checkbox" value="LGBT">Lesbian/Gay/Bisexual/Transgender
        </label>
    </div>
    <br>
</fieldset>
...
<div class="footer">
    <hr>
    For the Emory School of Public Health and Hispanic Health Coalition of Georgia. Designed by Health Coders&trade; and Hamilton Evans Cahill
</div>
</body>
</html>
